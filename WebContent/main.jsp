...
<div class="menu">
	<ul class="menu_ul">
        ...
        <li>
        	<a href="#" onclick="careful()">手机</a>
        </li>
        <li>
        	<a href="#" onclick="careful()">笔记本 平板</a>
        </li>
        <li>
        	<a href="#" onclick="careful()">智能穿戴</a>
        </li>
        <li>
        	<a href="#" onclick="careful()">智能家居</a>
        </li>
        <li>
        	<a href="#" onclick="careful()">热销配件</a>
        </li>
         <li>
        	<a href="#" onclick="careful()">其他</a>
        </li>
    </ul>
